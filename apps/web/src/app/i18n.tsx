...
const english = {
  ...
  updateCloudflareAuthorization: "Update authorization",
  authorizeWorkersAi: "Enable Workers AI",
  cloudflareOAuthFailed: "Cloudflare connection failed",
  cloudflareConnected: "Connected",
  cloudflareAccount: "Account",
  selectCloudflareAccount: "Select an account",
  ...
  openWeChatMenu: "Tap the ··· menu in the top right",
  chooseOpenInBrowser: "Choose “Open in browser”",
...
const chineseSimplified: TranslationDictionary = {
  ...
  updateCloudflareAuthorization: "更新授权",
  authorizeWorkersAi: "启用 Workers AI",
  cloudflareOAuthFailed: "Cloudflare 连接失败",
  cloudflareConnected: "已连接",
  cloudflareAccount: "账户",
  selectCloudflareAccount: "选择账户",
  cacheDisabled: "禁用缓存",
  networkFirst: "网络优先",
  updatePrompt: "提示更新",
  localOnly: "仅用本地",
  ...
  openWeChatMenu: "点击右上角 ···",
  chooseOpenInBrowser: "选择“在浏览器中打开”",
